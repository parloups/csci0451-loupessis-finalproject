...
Route Classifier class for the fourth model
  Targets are 2nd set of labels
...
class RouteClassifier4(nn.Module):
  def __init__(self, input_size=6, snap_size=2, hidden_size=64, num_layers=2, num_classes=15, dropout=0.6):
    """
        Dropout increased to 0.6 to compensate for the harder
        classification task and greater class imbalance across 15 classes.
        ...
        Args:
            ...
            dropout:     dropout rate — increased to 0.6 for stronger regularization
      """
    super().__init__()
