...
# instantiate model
model = RouteClassifier1()
TrainEval = TrainEval(model, second_labels=False)

# run cross validation
train_acc, train_loss, train_cm, val_acc, val_loss, val_cm = TrainEval.cv_train(RouteClassifier1, X_train, y_train,
